...
It was forked again as (https://github.com/corvee-ninja/enumer) to add support for string constants.
...
For more information, see:
        http://godoc.org/github.com/corvee-ninja/enumer
Flags:
  -addprefix string
...
```golang
//go:generate go run github.com/corvee-ninja/enumer -type=YOURTYPE
```
